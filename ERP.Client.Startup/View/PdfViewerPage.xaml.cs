...
namespace ERP.Client.Startup.View
{
    ...
    {
        public delegate void ButtonCloseClickedHandler(PdfViewerPage pdfViewer);
        public event ButtonCloseClickedHandler ButtonCloseClicked;

        public delegate void ButtonFavoriteToggledHandler(PdfViewerPage pdfViewer, PdfFileModel pdfFile);
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            IsMainPdfFile = parameters[2] as bool?;
